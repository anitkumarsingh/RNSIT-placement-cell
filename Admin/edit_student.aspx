<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_student.aspx.cs" Inherits="PPC.admin.edit_student" %>
   ...
   <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Student USN <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            <asp:Label ID="Label1" runat="server" Text="Select USN:" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:DropDownList ID="DropDownList2" runat="server" BackColor="#0099FF" 
                                    ForeColor="White" Height="35px" Width="248px" >
                                    <asp:ListItem>Select Student USN</asp:ListItem>
                                 </asp:DropDownList>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="butnSubmit" runat="server" CssClass="btn btn-primary" 
                                    Text="VIEW STUDENT" Height="46px" 
                                   ValidationGroup="Group1" Width="235px" onclick="butnSubmit_Click" />                             
                            </div>
                        </div>              
                    </fieldset>
                </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Student Details Editing Form <i class="fa fa-pencil pull-right"></i></legend>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="* Please fill the Text Box." 
                                   ValidationGroup="Group2" ControlToValidate="TextBox7" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
                                   ...
                                   ValidationGroup="Group2" BackColor="White" ForeColor="Red"></asp:RegularExpressionValidator>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* Please fill the Text Box." 
                                   ValidationGroup="Group2" ControlToValidate="TextBox4" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                    ControlToValidate="TextBox4" ErrorMessage="* Enter only letters." 
                                   ValidationGroup="Group2" ValidationExpression="[a-zA-Z ]+" BackColor="White" ForeColor="Red"></asp:RegularExpressionValidator>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox8" runat="server" placeholder="Password" CssClass="form-control" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* Please fill the Text Box." 
                                   ValidationGroup="Group2" ControlToValidate="TextBox8" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label2" runat="server" Text="10th % / CGPA" CssClass="col-lg-2 control-label" ></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="10th % / CGPA" CssClass="form-control" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="* Please fill the Text Box." 
                                  ValidationGroup="Group2" ControlToValidate="TextBox1" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                   ValidationGroup="Group2" ErrorMessage="* Enter valid and only first two digits of your percentage." ControlToValidate="TextBox1" ValidationExpression="^[1-9]?[0-9]{1}$|^100$"></asp:RegularExpressionValidator>
                           
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label3" runat="server" Text="12th / Diploma % / CGPA" CssClass="col-lg-2 control-label" ></asp:Label>
                            <div class="col-lg-10">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="* Please fill the Text Box." 
                                   ValidationGroup="Group2" ControlToValidate="TextBox2" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" 
                                  ValidationGroup="Group2"  ErrorMessage="* Enter valid and only first two digits of your percentage." ControlToValidate="TextBox2" ValidationExpression="^[1-9]?[0-9]{1}$|^100$"></asp:RegularExpressionValidator>
                           
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label4" runat="server" Text="U.G % / CGPA" CssClass="col-lg-2 control-label" ></asp:Label>
                            <div class="col-lg-10">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="* Please fill the Text Box." 
                                   ValidationGroup="Group2" ControlToValidate="TextBox3" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" 
                                   ValidationGroup="Group2" ErrorMessage="* Enter valid and only first two digits of your percentage." ControlToValidate="TextBox3" ValidationExpression="^[1-9]?[0-9]{1}$|^100$"></asp:RegularExpressionValidator>
                           
                            </div>
                        </div>

                        <div class="form-group">
                            <asp:Label ID="Label5" runat="server" Text="P.G % / CGPA" CssClass="col-lg-2 control-label" ></asp:Label>
                            <div class="col-lg-10">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="* Please fill the Text Box." 
                                  ValidationGroup="Group2"  ControlToValidate="TextBox5" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" 
                                  ValidationGroup="Group2"  ErrorMessage="* Enter valid and only first two digits of your percentage." ControlToValidate="TextBox5" ValidationExpression="^[1-9]?[0-9]{1}$|^100$"></asp:RegularExpressionValidator>
                           
                            </div>
                        </div>

                        <div class="form-group">
                            <asp:Label ID="Label16" runat="server" Text="Email" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="* Please fill the Text Box." 
                                  ValidationGroup="Group2"  ControlToValidate="TextBox6" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                           ...
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="* Please fill the Text Box." 
                                  ValidationGroup="Group2"  ControlToValidate="TextBox9" BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:DropDownList ID="DropDownList1" runat="server" BackColor="#0099FF" ForeColor="White">
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" 
                                   ValidationGroup="Group2" Text="Update" onclick="btnSubmit_Click" />
                                  <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-warning" 
                                    ...
                                    Text="CLEAR"  CausesValidation="False" onclick="Button1_Click" />                              
