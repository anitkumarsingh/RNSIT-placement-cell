<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_company.aspx.cs" Inherits="PPC.admin.view_company" %>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>View Company List. <i class="fa fa-pencil pull-right"></i></legend>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ...
                            SelectCommand="SELECT CompanyID, CompanyName, Email, ContactNumber FROM tbl_Company"></asp:SqlDataSource>
