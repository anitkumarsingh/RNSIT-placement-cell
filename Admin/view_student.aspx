<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_student.aspx.cs" Inherits="PPC.admin.view_student" %>
...
<body>
   ...
   <div class="container">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            <div id="banner">
                <h1>
                   <strong>RN Shetty's Education Soceity</strong></h1>
            </div>
        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="butnSubmit" runat="server" CssClass="btn btn-primary" 
                                    Text="B.E" Height="46px" Width="182px" onclick="butnSubmit_Click" />                             
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" 
                                    Text="MCA" Height="46px" Width="182px" onclick="Button1_Click"/>                             
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" 
                                    Text="MBA" Height="46px" Width="182px" onclick="Button2_Click"/>                             
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button3" runat="server" CssClass="btn btn-primary" 
                                    Text="MTECH" Height="46px" Width="182px" onclick="Button3_Click"/>                             
                            </div>
                        </div>
