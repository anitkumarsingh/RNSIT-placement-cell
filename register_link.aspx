<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register_link.aspx.cs" Inherits="PPC.register_link" %>
...
<body>
    ...
    <div class="container">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            <div id="banner">
                <h1>
                   <strong>RN Shetty Education Society</strong></h1>
                <h5>
                    <strong></strong></h5>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Company Registration Link <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="butnSubmit" runat="server" CssClass="btn btn-primary" Text="CLICK HERE" onclick="btnSubmit_Click13" Height="46px" Width="182px" />                             
                            </div>
                        </div>

                        <legend>Student Registration Link <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="CLICK HERE" onclick="btnSubmit_Click14" Height="46px" Width="182px" />                             
                            </div>
                        </div>
                    </fieldset>
                </div>
