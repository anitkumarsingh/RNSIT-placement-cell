<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_home.aspx.cs" Inherits="PPC.student.student_home" %>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Student Domain Forms <i class="fa fa-pencil pull-right"></i></legend>
                       
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="butnSubmit" runat="server" CssClass="btn btn-primary" 
                                    Text="EDIT PROFILE" Height="46px" Width="182px" onclick="butnSubmit_Click" />                             
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" 
                                    Text="VIEW COMPANY" Height="46px" Width="182px" onclick="Button1_Click" />                             
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" 
                                    Text="EXAM RESULTS" Height="46px" Width="182px" onclick="Button2_Click" />                             
                                <br />
                            </div>
