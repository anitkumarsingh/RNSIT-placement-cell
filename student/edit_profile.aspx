<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_profile.aspx.cs" Inherits="PPC.student.edit_profile" %>
...
<body>
   ...
   <div class="container">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center">
            <div id="banner">
                <h1>
                   <strong>Welcome to your home page</strong></h1>
                <h5>
                    <strong></strong></h5>
            </div>
        </div>
                ...
                <div class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox7" runat="server" placeholder="Student USN" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox4" runat="server" placeholder="Student Name" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="10th % / CGPA" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox2" runat="server" placeholder="12th / Diploma % / CGPA" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="Under Graduation" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox5" runat="server" placeholder="Post Graduation" CssClass="form-control" ReadOnly="True"></asp:TextBox>
                        ...
                        <br/><p>Fields marked with '*' cannot be edited. To edit contact placement co-ordinator. </p>
                    </fieldset>
                </div>
            </div>
        </div>
