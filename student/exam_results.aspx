<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="exam_results.aspx.cs" Inherits="PPC.student.exam_results" %>
   ...
   <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Click Below To View Your Exam Result. <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:DropDownList ID="DropDownList2" runat="server" BackColor="#0099FF" 
                                    ...
                                    <asp:ListItem>Select Exam Code</asp:ListItem>
                                 </asp:DropDownList>
                            ...
                            <div class="col-lg-10 col-lg-offset-2">
                               <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" 
                                     Text="VIEW RESULTS" Height="46px" Width="182px" 
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Your Exam Result. <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
