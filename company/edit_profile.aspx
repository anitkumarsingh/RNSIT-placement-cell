<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_profile.aspx.cs" Inherits="PPC.company.edit_profile" %>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Company Details Editing Form <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            <asp:Label ID="Label6" runat="server" Text="Company Name" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox4" runat="server" placeholder="Company Name" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox1" runat="server" placeholder="Email" CssClass="form-control" ReadOnly="true" ></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="* Enter valid E-Mail format." ControlToValidate="TextBox1" 
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label4" runat="server" Text="Repeat Password" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox5" runat="server" placeholder="Repeat Password" CssClass="form-control" ></asp:TextBox>           
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label3" runat="server" Text="Contact Number" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="Contact Number" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" onclick="btnSubmit_Click10" />
