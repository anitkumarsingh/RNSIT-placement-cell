<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_exam.aspx.cs" Inherits="PPC.company.edit_exam" %>
                ...
                <div class="form-horizontal">
                    <fieldset>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-lg-10">
                            <asp:TextBox ID="TextBox7" runat="server" placeholder="Question Number" 
                                    CssClass="form-control" Height="36px" Width="152px"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="* Please fill the Text Box." 
                                    ControlToValidate="TextBox7" BackColor="White" ForeColor="Red" ValidationGroup="Group1" 
                                    ></asp:RequiredFieldValidator>
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                    ErrorMessage="* Enter valid and maximum of two numbers." 
                                    ControlToValidate="TextBox7" ValidationExpression="^[1-9]?[0-9]{1}$|^99$" ValidationGroup="Group1"></asp:RegularExpressionValidator>
                           
                            &nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" 
                                    Text="DISPLAY" Height="42px" Width="116px" onclick="btnSubmit_Click19" 
                    ...
                    <fieldset>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <asp:TextBox ID="TextBox5" runat="server" placeholder="Answer" CssClass="form-control"></asp:TextBox>
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="* Enter Option number only"
                                   ...
                                   ValidationGroup="Group2" ValidationExpression="^[1-4]" ></asp:RegularExpressionValidator>   
                             </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-warning" 
                                    Text="UPDATE" Height="42px" Width="107px" onclick="btnCancel_Click21" 
                                    ValidationGroup="Group2" />
                            <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-warning" 
                                    Text="CLEAR" Height="42px" Width="107px" onclick="btnCancel_Click20" 
