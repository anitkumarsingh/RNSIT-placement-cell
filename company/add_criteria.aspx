<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_criteria.aspx.cs" Inherits="PPC.company.add_criteria" %>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Company's Add Criteria Form <i class="fa fa-pencil pull-right"></i></legend>
                        
                        <div class="form-group">
                            <asp:Label ID="Label9" runat="server" Text="Visiting Date" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox7" runat="server" placeholder="DD/MM/YYYY [FORMAT]" CssClass="form-control"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                    ErrorMessage="* Please fill the Text Box." ControlToValidate="TextBox7"
                                    BackColor="White" ForeColor="Red"></asp:RequiredFieldValidator>
                                <asp:Label ID="Label10" runat="server" Text="* Date greater than today's."></asp:Label> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" Text="Submit" onclick="btnSubmit_Click11" />
                                  <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-warning" 
                                    Text="Cancel" onclick="btnCancel_Click1" CausesValidation="False" />                              
                            </div>
                        </div>
                    </fieldset>
                </div>
