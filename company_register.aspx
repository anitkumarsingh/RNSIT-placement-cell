<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company_register.aspx.cs" Inherits="PPC.company_register" %>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="registrationform">
                <div class="form-horizontal">
                    <fieldset>
                        <legend>Company Registration Form <i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                            <asp:Label ID="Label6" runat="server" Text="Company Name" CssClass="col-lg-2 control-label"></asp:Label>
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox4" runat="server" placeholder="Company Name" CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="* Enter valid E-Mail format." ControlToValidate="TextBox1" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="Contact Number" CssClass="form-control"></asp:TextBox>
